"""Tests for init_project_v11 (sqlite path; postgres is integration-only)."""
...
from fdl.init_v11 import init_project_v11


def test_defaults_create_sqlite_project(fdl_project_dir):
    init_project_v11("myds", project_dir=fdl_project_dir)
...
def test_rollback_on_failure(fdl_project_dir, monkeypatch):
    ...
    monkeypatch.setattr("fdl.ducklake.init_ducklake_v11", _boom)
